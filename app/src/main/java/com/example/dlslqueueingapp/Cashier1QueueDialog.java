...
public class Cashier1QueueDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_cashier1holder, null);

        builder.setView(view).setTitle("Cashier 1").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            @Override
