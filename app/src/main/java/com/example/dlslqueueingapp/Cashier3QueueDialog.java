...
public class Cashier3QueueDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_cashier3holder, null);

        builder.setView(view).setTitle("Cashier 3").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            @Override
