...
public class Cashier4QueueDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_cashier4holder, null);

        builder.setView(view).setTitle("Cashier 4").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            @Override
